...
TOOL_REGISTRY = {
    ...
    "teochat": _function_tool("teochat", "Analyze a supported paired optical and SAR request.", {"observation_1_id": {"type": "string"}, "observation_2_id": {"type": "string"}, "prompt": {"type": "string"}}, ["observation_1_id", "observation_2_id", "prompt"]),
    "m2cd": _function_tool("m2cd", "Detect spatial change between corresponding observations.", {"observation_1_id": {"type": "string"}, "observation_2_id": {"type": "string"}}, ["observation_1_id", "observation_2_id"]),
